...
export default function ProjectDocumentsPage() {
  ...
  const fetchDocuments = async () => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/api/documents/project/${params.id}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
  ...
  const canUpload = hasPermission("projects-documents-upload", permissions);
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Document library for this project - Role: {roleData.name}
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  ...
                  from other projects. Access is controlled by your project role
                  and permissions.
                </p>
              </div>
            </div>
