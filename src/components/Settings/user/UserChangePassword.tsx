    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={`w-full px-4 py-2.5 pr-10 rounded-lg border text-sm text-gray-800 dark:text-gray-100 bg-white dark:bg-gray-900 focus:outline-none focus:ring-2 transition ${
            error
              ? "border-red-300 dark:border-red-600 focus:ring-red-200 dark:focus:ring-red-900/40 focus:border-red-400 dark:focus:border-red-500"
              : "border-gray-200 dark:border-gray-700 focus:ring-indigo-200 dark:focus:ring-indigo-900/40 focus:border-indigo-400 dark:focus:border-indigo-500"
          }`}
        />
        <button
          type="button"
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg overflow-hidden">
            <div className="p-8 space-y-6">
              ...
              {/* Requirements hint */}
              <div className="px-4 py-3.5 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-2">
                      <Check
                        size={16}
                        className={`transition-colors flex-shrink-0 ${req.met ? "text-emerald-500" : "text-gray-300 dark:text-gray-600"}`}
                      />
                      <span
                        className={`text-sm transition-colors ${req.met ? "text-emerald-700 dark:text-emerald-400 font-medium" : "text-gray-500 dark:text-gray-300"}`}
                      >
                        {req.text}
                      </span>
                    </li>
            ...
            {/* Footer */}
            <div className="px-8 py-5 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
              <button
                onClick={() => window.history.back()}
                className="px-6 py-3 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-100 text-sm font-medium rounded-lg transition"
              >
                Cancel
              </button>
              <button
