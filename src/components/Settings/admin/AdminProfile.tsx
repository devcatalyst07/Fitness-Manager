...
function EditProfileModal({
  ...
  onSave: (updated: AdminProfileData) => void;
}) {
            ...
            <div className="px-8">
              <div className="flex flex-col items-center mb-8 pb-8 border-b border-gray-200">
                <label className="cursor-pointer flex flex-col items-center">
                  ...
                  <span className="text-sm text-black font-medium mt-3 hover:text-blue-600 transition-colors">
                    Change Photo
                  </span>
                  <input
                    type="file"
