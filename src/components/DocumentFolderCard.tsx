...
import { Folder, FileText, MoreVertical, Trash2, Download, Eye } from 'lucide-react';
      ...
      <div className="divide-y divide-gray-100">
        {documents.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500 text-sm">Kindly check the project folder(s) for the complete set of files.</p>
          </div>
        ) : (
          documents.map((doc) => (
            <div
