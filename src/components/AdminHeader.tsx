...
export default function AdminHeader({ onRoleRequestClick }: AdminHeaderProps) {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 lg:left-[var(--fm-sidebar-width)] h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 sm:px-6 lg:px-8 z-30 transition-all duration-300">
