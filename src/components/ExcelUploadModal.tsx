...
export default function ExcelUploadModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white w-full max-w-[min(64rem,100vw-1rem)] rounded-2xl shadow-2xl max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        ...
        <div className="border-t border-gray-200 px-4 sm:px-6 lg:px-8 py-4 bg-gray-50">
          <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3">
            <button
              onClick={handleDownloadTemplate}
              className="inline-flex items-center justify-center gap-2 px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors text-sm font-medium w-full sm:w-auto"
            >
              <Download size={16} />
              Download Template
            </button>
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 bg-green-600 text-white font-semibold rounded-xl 
